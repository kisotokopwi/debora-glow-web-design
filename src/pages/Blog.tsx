        ...
        {isLoading ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredPosts.map((post) => (
              <Card key={post.id} className="group cursor-pointer border-0 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-white">
                <Link to={`/blog/${post.slug}`}>
                  ...
                  <CardContent className="p-6">
                    <h3 className="font-semibold text-xl text-gray-800 mb-2 group-hover:text-rose-600 transition-colors">
                      {post.title}
                    </h3>
